...
const infoCards = [
    ...
    { color: '#4527a0', title: 'News by Terms', info: 'Bitcoin, Playstation 5, Smartphones, Elon Musk...',text: 'What\'s up with PlayStatin 5' },
                    ...
                    {infoCards.map((infoCard) => (
                        <Grid item xs={12} sm={6} md={4} lg={3} className={classes.infoCard}>
                            <div className={classes.card} style={{ backgroundColor: infoCard.color }}>
                                ...
                                { infoCard.info ?  (<Typography varient="h6"><strong>{infoCard.title.split(' ')[2]}:<br/>{infoCard.info}</strong></Typography>) : null}
